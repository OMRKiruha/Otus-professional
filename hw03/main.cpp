...
int main([[maybe_unused]] int argc, [[maybe_unused]] char const *argv[]) {
    ...
    std::map<int32_t, int32_t, std::less<>, std::allocator<std::pair<int32_t, int32_t>>> my_allocator_map;
    ...
    MyForwardList<int32_t> std_allocator_forward_list;

    // заполнение 10 элементами от 0 до 9
    fillBySequence(std_allocator_forward_list, 0, 9);

    // создание экземпляра своего контейнера для хранения значений типа int с новым аллокатором, ограниченным 10 элементами
    MyForwardList<int32_t> my_allocator_forward_list;

    // заполнение 10 элементами от 0 до 9
    fillBySequence(my_allocator_forward_list, 0, 9);

    // вывод на экран всех значений, хранящихся в контейнере
    printContainer(std_allocator_forward_list, "MyForwardList with std::allocator");
    printContainer(my_allocator_forward_list, "MyForwardList with std::allocator");
